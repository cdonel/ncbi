...
class FetchRecords:
    ...
    def __init__(self, primary_ids=None, db=None, idtype=None, rettype=None, retmode=None, filename=None):
    ...
    def fetch_records(self, db, rettype, retmode, batch_size, idtype, primary_ids, filename):
